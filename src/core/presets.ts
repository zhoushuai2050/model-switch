import type { AgentId, ProtocolConfig } from './types.ts';

export interface Preset {
  id: string;
  name: string;
  websiteUrl?: string;
  protocols: Partial<Record<'openai' | 'anthropic' | 'gemini', ProtocolConfig>>;
  models: Array<{ modelId: string; alias?: string; agentHint?: AgentId | 'any' }>;
}
