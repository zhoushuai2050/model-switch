...
export function topLevelText(text) {
...
export function getTopLevel(text, key) {
...
export function setTopLevel(text, key, value) {
...
export function findTableSpan(text, header) {
...
export function listTables(text, prefix) {
    const names = [];
    const re = /^\[([^\]]+)\][ \t]*$/gm;
    let match;
...
export function upsertTable(text, header, entries) {
    const lines = [`[${header}]`];
